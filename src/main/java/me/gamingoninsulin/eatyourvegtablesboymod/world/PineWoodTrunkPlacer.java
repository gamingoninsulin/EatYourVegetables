...
public class PineWoodTrunkPlacer extends TrunkPlacer {
    public static final Codec<PineWoodTrunkPlacer> CODEC = RecordCodecBuilder.create(pineWoodTrunkPlacerInstance ->
            fillTrunkPlacerFields(pineWoodTrunkPlacerInstance).apply(pineWoodTrunkPlacerInstance, PineWoodTrunkPlacer::new));
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random,
        ...
        return ImmutableList.of(new FoliagePlacer.TreeNode(startPos.up(height_), 2, false));
    }
}