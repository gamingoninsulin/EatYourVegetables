package me.gamingoninsulin.eatyourvegtablesboymod.datagen.recipe;
...
public class CheeseFormStationRecipeGen implements CraftingRecipeJsonBuilder {
    private final Item result;
    private final Ingredient ingredient;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.create();

    public CheeseFormStationRecipeGen(ItemConvertible ingredient, ItemConvertible result, int count) {
    ...
    public static class JsonBuilder implements RecipeJsonProvider {
        ...
        public Identifier getRecipeId() {
            return new Identifier(Reference.MOD_ID,
                    Registries.ITEM.getId(this.result).getPath() + "_from_cheese_forming");
        }

        @Override
        public RecipeSerializer<?> getSerializer() {
            return CheeseFormPressRecipe.Serializer.INSTANCE;
        }
