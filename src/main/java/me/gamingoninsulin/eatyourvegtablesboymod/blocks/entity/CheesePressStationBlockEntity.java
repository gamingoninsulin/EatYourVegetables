...
import me.gamingoninsulin.eatyourvegtablesboymod.screen.CheeseFormPressScreenHandler;
...
//    };
    ...
    public boolean canInsert(int slot, ItemStack stack, @Nullable Direction side) {
        Direction localDir = this.getWorld().getBlockState(pos).get(CheesePressBlock.FACING);
    ...
    public boolean canExtract(int slot, ItemStack stack, Direction side) {
        Direction localDir = this.getWorld().getBlockState(this.pos).get(CheesePressBlock.FACING);
    ...
    public Text getDisplayName() {
        return Text.literal("Cheese Forming Station");
    }
