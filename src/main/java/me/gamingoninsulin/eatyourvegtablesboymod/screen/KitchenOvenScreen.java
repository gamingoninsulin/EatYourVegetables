...
import me.gamingoninsulin.eatyourvegtablesboymod.screen.renderer.EnergyInfoArea;
import me.gamingoninsulin.eatyourvegtablesboymod.screen.renderer.FluidStackRenderer;
import me.gamingoninsulin.eatyourvegtablesboymod.util.MouseUtil;
...
public class KitchenOvenScreen extends HandledScreen<CheeseFormPressScreenHandler> {
    ...
    public KitchenOvenScreen(CheeseFormPressScreenHandler handler, PlayerInventory inventory, Text title) {
