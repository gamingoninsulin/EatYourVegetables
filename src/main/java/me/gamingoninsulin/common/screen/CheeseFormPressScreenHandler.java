...
public class CheeseFormPressScreenHandler extends ScreenHandler {
    ...
    public CheeseFormPressScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.CHEESE_FORM_PRESS_STATION_SCREEN_HANDLER, syncId);
